...
activities = {
    ...
    "Soccer Practice": {
        "description": "Team soccer training and scrimmages for all skill levels",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["alex@mergington.edu", "isabella@mergington.edu"]
    },
    "Swimming Team": {
        "description": "Swim practice and meets to improve endurance and technique",
    ...
    "Drama Workshop": {
        "description": "Acting, improvisation, and theater production exercises",
    ...
    "Debate Team": {
        "description": "Research and debate current issues in team and individual rounds",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
